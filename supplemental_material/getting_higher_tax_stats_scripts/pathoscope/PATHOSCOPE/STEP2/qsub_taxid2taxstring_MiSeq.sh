...
#PBS -j oe
#PBS -o /home/playera1/sandbox/classifier_comparison2/higher_tax_STATS/PATHOSCOPE/qsub_taxid2taxstring_MiSeq.log
...
outpath="$path/STEP2/leaftoRoot_MiSeq"
mkdir -p "$outpath"

find "$path/STEP1/ID_breakout_taxid_ONLY_MiSeq" -name "*.pathoID.taxids" | while read filepath;do
