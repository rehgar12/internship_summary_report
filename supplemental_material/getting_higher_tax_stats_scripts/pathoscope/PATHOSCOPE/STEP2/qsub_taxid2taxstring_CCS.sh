...
#PBS -j oe
#PBS -o /home/playera1/sandbox/classifier_comparison2/higher_tax_STATS/PATHOSCOPE/qsub_taxid2taxstring_CCS.log
...
outpath="$path/STEP2/leaftoRoot_CCS"
mkdir -p "$outpath"

find "$path/STEP1/ID_breakout_taxid_ONLY_CCS" -name "*.pathoID.taxids" | while read filepath;do
