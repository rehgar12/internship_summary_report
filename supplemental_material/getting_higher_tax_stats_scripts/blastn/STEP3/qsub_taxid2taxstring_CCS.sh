#PBS -N taxid2taxstring_CCS
#PBS -m ae
#PBS -M playera1@jhuapl.edu
#PBS -l nodes=1:ppn=4
#PBS -l walltime=240:00:00
#PBS -j oe
#PBS -o /home/playera1/sandbox/classifier_comparison2/higher_tax_STATS/BLASTN/qsub_taxid2taxstring_CCS.log
...
outpath="$path/STEP3/leaftoRoot_CCS"
mkdir -p "$outpath"

find "$STEP2/gi_pair_count_CCS.breakout/pred_ti_lists" -name "*.pti_list" | while read pti_filepath;do
