#PBS -N krakenReports_CCS
#PBS -m ae
#PBS -M playera1@jhuapl.edu
#PBS -l nodes=1:ppn=16
#PBS -l walltime=240:00:00
#PBS -j oe
#PBS -o /home/playera1/sandbox/classifier_comparison2/kraken_singles/krakenReport_CCS.log
...
input_dir="/home/playera1/sandbox/classifier_comparison2/kraken_singles/kraken_breakout/kraken_output_1k_CCS"
outpath="/home/playera1/sandbox/classifier_comparison2/kraken_singles/REPORT_and_STATS/reports_CCS"
mkdir -p "$outpath"
