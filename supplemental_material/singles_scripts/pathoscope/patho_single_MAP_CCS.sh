#PBS -N patho_single_MAP_CCS
#PBS -m ae
#PBS -M playera1@jhuapl.edu
#PBS -l nodes=1:ppn=16
#PBS -l walltime=240:00:00
#PBS -j oe
#PBS -o /home/playera1/sandbox/classifier_comparison2/pathoscope_singles/patho_single_MAP_CCS.log
...
outpath="/home/playera1/sandbox/classifier_comparison2/pathoscope_singles/results_patho_singles_CCS"
mkdir -p "$outpath"

metagenomic_input="/home/playera1/sandbox/classifier_comparison2/metagenomic_input/PATHOSCOPE_input/CCS_meta_sim_1k"
