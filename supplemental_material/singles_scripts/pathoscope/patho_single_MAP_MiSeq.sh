#PBS -N patho_single_MAP_MiSeq
#PBS -m ae
#PBS -M playera1@jhuapl.edu
#PBS -l nodes=1:ppn=16
#PBS -l walltime=240:00:00
#PBS -j oe
#PBS -o /home/playera1/sandbox/classifier_comparison2/pathoscope_singles/patho_single_MAP_MiSeq.log
...
outpath="/home/playera1/sandbox/classifier_comparison2/pathoscope_singles/results_patho_singles_MiSeq"
mkdir -p "$outpath"

metagenomic_input="/home/playera1/sandbox/classifier_comparison2/metagenomic_input/PATHOSCOPE_input/MiSeq_meta_sim_1k"
...
find "$metagenomic_input" -name "*.fq" -print0 | parallel -0 -n 1 -P 32 -I '{}' patho_MAP_one '{}'
