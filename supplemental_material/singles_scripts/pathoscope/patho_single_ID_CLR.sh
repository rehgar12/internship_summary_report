#PBS -N patho_single_ID_CLR
#PBS -m ae
#PBS -M playera1@jhuapl.edu
#PBS -l nodes=1:ppn=32
#PBS -l walltime=240:00:00
#PBS -j oe
#PBS -o /home/playera1/sandbox/classifier_comparison2/pathoscope_singles/patho_single_ID_CLR.log
...
outpath="$patho_path/REPORTS_and_STATS/patho_singles_ID_CLR_results"
mkdir -p "$outpath"

input="$patho_path/results_patho_singles_CLR"
