#PBS -N patho_comp_target-lib-build
#PBS -m ae
#PBS -M playera1@jhuapl.edu
#PBS -l nodes=1:ppn=16
#PBS -l walltime=240:00:00
#PBS -j oe
#PBS -o /home/playera1/sandbox/classifier_comparison/pathoscope/patho_comp_target-lib-build.log
...
target_lib_data="/home/playera1/sandbox/classifier_comparison/pathoscope/all_BV.fna"
...
pathoscope LIB -genomeFile $target_lib_data -outPrefix patho_comp_target-lib-build
